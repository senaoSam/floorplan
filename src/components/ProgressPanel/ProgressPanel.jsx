    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'HM-T5', done: false, text: 'Edge-case fixtures（refl-min ✅ / dense-walls / dense-aps / cross-floor-tunneling）' },
          { id: 'HM-F5a', done: true, text: 'WebGL shader MVP（Friis + 牆穿透 + Z 過濾 + slab + opening + omni/directional）' },
          { id: 'HM-F5b', done: true,  text: 'Uniform Grid 空間加速（DDA 走 cell；100 AP×2000 牆 JS 155s → Shader 129ms = 1196×）⚠️ 單一垂直牆有漏算 bug（refl-min 顯示）' },
          { id: 'HM-F5b-fix', done: false, text: 'F5b 單一垂直牆 grid 漏算修復（延後到 F5g 開工前再決定是否單獨處理）' },
