  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { id: 'HM-T1', done: false, text: 'Golden test fixture（固定場景 JS baseline）' },
          { id: 'HM-T2', done: false, text: 'Diff harness（shader vs JS 逐格 dB diff）' },
          { id: 'HM-T3', done: false, text: 'CPU 對照模式開關（UI 一鍵切回 JS 引擎）' },
          { id: 'HM-T4', done: false, text: 'F5 子階段驗收門檻（F5a ≤3dB / F5c ≤1.5dB / F5d ≤1dB）' },
          { id: 'HM-F5a', done: false, text: 'WebGL shader MVP（Friis + 牆穿透 + Z 過濾 + slab）' },
          { id: 'HM-F5b', done: false, text: 'BVH / Uniform Grid 空間加速' },
          { id: 'HM-F5c', done: false, text: '反射 + 複數 Fresnel 移植' },
          { id: 'HM-F5d', done: false, text: '多頻點相干疊加 + 繞射' },
