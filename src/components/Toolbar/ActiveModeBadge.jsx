...
const MODE_HINT = {
  ...
  [EDITOR_MODE.DRAW_WALL]:        { group: '結構',     name: '畫牆模式',  accent: 'structure', hint: '左鍵點擊設定端點，右鍵或 Esc 結束｜數字鍵 1~6 切換材質' },
  [EDITOR_MODE.DOOR_WINDOW]:      { group: '結構',     name: '門窗模式',  accent: 'structure', hint: '點擊牆體兩點設定門/窗位置；D 切換門、W 切換窗；右鍵或 Esc 取消' },
