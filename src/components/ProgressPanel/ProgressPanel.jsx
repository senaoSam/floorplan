    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: 'P-2', done: false, text: 'LOD 拖曳降解析度（renderScale 0.7，放開 full-res）' },
          { id: 'P-3', done: false, text: 'AP 拖曳時 Heatmap 低頻 preview（100~150ms）' },
          { id: 'P-4', done: false, text: 'WebGL Heatmap dirty-check 閾值放寬（≥1px）' },
          { id: 'P-5', done: false, text: 'History snapshot 非阻塞 + flushPending' },
          { id: 'P-6', done: false, text: 'WallLayer snap bounding box 過濾' },
          { id: 'P-7', done: false, text: 'Editor2D 鍵盤 effect 依賴穩定化' },
          { id: 'P-8', done: false, text: 'Dirty Rect 區域重繪（雙 FBO + scissor）' },
        ],
      },
    ],
  },
