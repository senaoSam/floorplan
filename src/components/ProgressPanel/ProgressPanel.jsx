    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'HM-F5i', done: false, text: 'Refl/Diff 接上 wall grid（DDA 走格 + skip semantics）' },
          { id: 'HM-F5j', done: false, text: 'Per-AP LOS field bake（drag 期間取回完整 refl/diff）' },
          { id: 'HM-F5k', done: false, text: 'AP→corner / AP→wall 鏡像 precompute texture' },
          { id: 'HM-F5l', done: false, text: 'Coarse-fine 擴張到 refl/diff（物理 upper bound mask）' },
          { id: 'HM-F5m', done: false, text: 'F5c+ 改 4-AP batch（解 readPixels roundtrip）' },
