...
> **剩下未做（需先討論）**：D6 熱圖室外滿江紅、D7 <1196px 佈局重疊；D8 無法重現；D9 的 ②⑤⑥⑦；E8 狀態衛生。
...
> **批次 4 剩下的（使用者未拍板，需先討論範圍）**：
> **52-D6**（熱圖室外滿江紅）與 **52-D7**（<1196px 佈局重疊 + resize 不重新 fit）—— 兩條都要動版面或熱圖預設行為，影響面比其他 D 項大，開工前先確認方向。
