    ...
    groups: [
      {
        ...
        items: [
          { id: '13-1', done: false, text: 'CableSummaryPanel — 全建築 BOM（總線長、per-floor、per-routeStatus、unroutable 列表）' },
          { id: '13-2', done: false, text: 'Warnings 顯示 — buildGraph 已產生的 warnings（tray touching、共線重疊）' },
