...
// Phase 25 port — the original Konva stage arg is now a PIXI scene
// (app + world). capturePlanPng's signature is updated accordingly.

// Build the PDF document from already-computed planning data + a PIXI
// scene reference (so we can re-use capturePlanPng per floor).
//
// Inputs:
