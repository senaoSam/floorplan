...
// later. These match the AP defaults in DemoLoader so the stress APs feel
// coherent with the demo seeds.
const DEFAULT_AP_MODEL_ID = null
const DEFAULT_CHANNEL_WIDTH = { 2.4: 20, 5: 80, 6: 80 }
