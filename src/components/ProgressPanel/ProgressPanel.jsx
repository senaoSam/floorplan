    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'HM-T5', done: false, text: 'Edge-case fixtures（dense-walls / dense-aps / cross-floor-tunneling）' },
          ...
          { id: 'HM-F5c', done: false, text: '反射 + 複數 Fresnel + 繞射移植' },
          { id: 'HM-F5d', done: false, text: '多頻點相干疊加（full parity）' },
