    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'HM-F3a', done: false, text: '樓板衰減計算（射線 × N 層 × 衰減）' },
          { id: 'HM-F3b', done: false, text: '樓板材質 UI' },
          { id: 'HM-F2a', done: false, text: 'FloorHole 穿透幾何判斷（bypass slab loss）' },
          { id: 'HM-F2b', done: false, text: 'Cross-floor 熱圖呈現（含上下樓 AP）' },
